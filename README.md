...
>
>I write a lot of 64bit as well as 32Bit code on the Pi so when I am accessign 32bit registers I will always use the C/C++ standard and use "uin32_t" as the type. If I used "int" then in 64 bit mode my registers would suddenly go to 64bit wide which is obviously wrong and fatal so most of my files will have #include <stdint.h> and use unit32_t types.  
>
