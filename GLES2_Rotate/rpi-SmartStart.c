...
typedef struct __attribute__((__packed__, aligned(4))) tagIMAGE_PTR {
	union {
		uint8_t* rawImage;
		RGB565* __attribute__((__packed__, aligned(1))) ptrRGB565;
...
bool PiConsole_Init (int Width, int Height, int Depth, printhandler prn_handler) {
	...
	switch (Depth) {
	case 32:
		console.ClearArea = ClearArea32;
		console.VertLine = VertLine32;
		console.HorzLine = HorzLine32;
		console.DiagLine = DiagLine32;
		console.WriteChar = WriteChar32;
		console.PutImage = PutImage32;
		break;
	case 24:
		console.ClearArea = ClearArea24;
		console.VertLine = VertLine24;
		console.HorzLine = HorzLine24;
		console.DiagLine = DiagLine24;
		console.WriteChar = WriteChar24;
		console.PutImage = PutImage24;
		break;
	case 16:
		console.ClearArea = ClearArea16;
		console.VertLine = VertLine16;
		console.HorzLine = HorzLine16;
		console.DiagLine = DiagLine16;
		console.WriteChar = WriteChar16;
		console.PutImage = PutImage16;
		break;
	}
