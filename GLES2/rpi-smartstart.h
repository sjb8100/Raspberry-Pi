...
#pragma pack(push, 1)								// Byte pack so it is 4 bytes
...
#pragma pack(push, 1)								// Byte pack so it is 2 bytes
...
{--------------------------------------------------------------------------*/
#pragma pack(push, 1)												// Structure byte aligned
