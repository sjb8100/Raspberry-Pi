...
@echo on
%bindir%aarch64-elf-gcc.exe %cpuflags% %asmflags% %linkerflags% -Wl,-T,rpi64.ld main.c SmartStart64.S rpi-SmartStart.c emb-stdio.c SDCard.c rpi-GLES.c %outflags% %libflags% 
@echo off
