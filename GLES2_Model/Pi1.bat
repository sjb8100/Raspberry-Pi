...
@echo on
%bindir%arm-none-eabi-gcc %cpuflags% %asmflags% %linkerflags% -Wl,-T,rpi32.ld main.c SmartStart32.S rpi-SmartStart.C emb-stdio.c rpi-GLES.c SDCard.c %outflags% %libflags%
@echo off
